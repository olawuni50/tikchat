...
const Navbar = () =>{
    ...
    return(
        ...
        border-gray-200 py-2 px-4">
            <Link href='/'>
            <div className='w-[50px] hidden md:block md:w-[130px] cursor-pointer font-bold' >
            ...
            <form onSubmit={handleSearch} className=" 
             bg-white">
                    ...
                    <input type='text' value={searchValue} onChange={(e) =>setSearchValue(e.target.value)} placeholder="Search videos"
                    className="bg-primary p-2 md:text-md font-medium border-2 
                    border-gray-100 focus:outline-none focus:border-2 
                    focus:border-gray-300 w-[165px] rounded-full"/>

                    {/* <button onClick={handleSearch} className="absolute md:right-5
            ...
            <div className="relative hidden md:block">
                <form onSubmit={handleSearch} className="absolute md:static
                top-10 left-20 bg-white">
                    ...
                    <div className="flex gap-5 md:gap-10">
                        <Link href = '/upload'>
                            ...
                            {userProfile.image && (
                                 ...
                                 src={userProfile.image} alt="profile photo" />
                                 </>
                                 </Link>
                            ) }
