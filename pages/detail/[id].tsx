        ...
        flex-wrap lg:flex-nowrap">
            ...
            flex justify-center items-center bg-black">
                ...
                <div className="absolute top-6 left-2 lg:left-6 flex gap-6 z-50">
                    <p className="cursor-pointer" title="Back to home" onClick ={() => router.back()}>
                ...
                <div className="relative">
                    <div className="lg:h-[100vh] h-[60vh]">
                        ...
                        loop onClick={onVideoClick} ref ={videoRef}>
                ...
                <div className="absolute bottom-5 lg:bottom-10 cursor-pointer right-5 
                lg:right-10">

                    {isVideoMuted ? (
                        <button onClick={()=>setIsVideoMuted(false)}> <HiVolumeOff className="text-white
            ...
            <div className="relative w-[1000px] md:w-[900px] lg:w-[700px]">
                ...
                <div className="flex gap-3 p-2 cursor-pointer font-semibold rounded">
                    ...
                    <div className="flex mt-3 flex-col gap-2">
                        ...
                        font-bold text-primary">{post.postedBy.userName} {''}
                ...
                <div className="mt-10 px-10">
                    {userProfile ? (
                        ...
                        <p className="text-xl font-bold items-center">Login to like post</p>
                    )}
                </div>
                <Comments comment={comment} comments={post.comments} setComment={setComment} addComment={addComment} 
